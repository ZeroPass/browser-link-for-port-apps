...
function readSettings(text) {
    try{
        DATA_IN_QR = JSON.stringify(text);
        let settings = {
...
var widgetHTML = '<div class="divbackgroundblack">' +
    '    <div class="divwindow">' +
    '      <div class="div1port">' +
    '        <div class="div1a"></div>' +
    '        <div class="div1a"><img src="images/port.link-logo.svg" loading="lazy" width="60" alt="" class="image"></div>' +
    '        <div class="div1x">' +
    '          <a href="#" class="linkblockx w-inline-block"><img src="../images/x-dark.svg" loading="lazy" width="16" alt=""' +
    '              class="xmouseover2"></a>' +
    '        </div>' +
    '      </div>' +
    '      <div>' +
    '        <div class="text1port">Attest</div>' +
    '        <div class="text2port">Scan the QR code with Port app, or press the button if the Port app is on the same' +
    '          device.</div>' +
    '      </div>' +
    '      <div class="divqr">' +
    '        <section id="qr-code"></section>' +
    '        <!--<img src="images/Capture.PNG" loading="lazy" width="452" alt="" class="image-2"> -->' +
    '      </div>' +
    '      <div class="div-button">' +
    '        <div class="textlink1">' +
    '          <a href="javascript:copyClipboard()" class="link-2">copy magnet link</a>' +
    '        </div>' +
    '        <a href="#" class="button w-button">Launch Port</a>' +
    '      </div>' +
    '      <div class="divdownload">' +
    '        <div class="textlink2">' +
    '          <a href="https://port.link" class="link">Download Port mobile app</a>' +
    '        </div>' +
    '      </div>' +
    '    </div>' +
    '  </div>' +
