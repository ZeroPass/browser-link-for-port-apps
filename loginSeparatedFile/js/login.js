...
var widgetHTML = '<div class="divbackgroundblack">'+
    ...
    '        <div class="div1x">'+
    '          <a href="#" class="linkblockx w-inline-block"><img src="../images/x-dark.svg" loading="lazy" width="16" alt="" class="xmouseover2"></a>'+
    '        </div>'+
    '      </div>'+
    '      <div>'+
    '        <div class="text1port">Attest</div>'+
    '        <div class="text2port">Scan the QR code with Port app, or press the button if the Port app is on the same device.</div>'+
    '      </div>'+
    '      <div class="divqr">' +
